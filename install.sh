...
export IO_PLATFORMS='declare -A io_platforms=( [zero]="arduino:samd:arduino_zero_native" [esp8266]="esp8266:esp8266:huzzah:FlashSize=4M,CpuFrequency=80" [esp32]="esp32:esp32:featheresp32:FlashFreq=80" )'
...
function build_platform()
{
  ...
  elif [[ ${avr_platforms[$platform_key]} ]]; then
    platform=${avr_platforms[$platform_key]}
